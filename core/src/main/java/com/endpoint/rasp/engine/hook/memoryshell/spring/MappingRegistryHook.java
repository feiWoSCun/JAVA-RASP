 ...
 */
@HookAnnotation
public class MappingRegistryHook extends AbstractMRVHook {
    @Override
    public boolean isClassMatched(String className) {
        return "org/springframework/web/servlet/handler/AbstractHandlerMethodMapping$MappingRegistry".equals(className);
    }

    @Override
    protected void hookMethod(CtClass ctClass) throws IOException, CannotCompileException, NotFoundException {
        String src = getInvokeStaticSrc(MappingRegistryHook.class, "checkRegister", "$0,$2", Object.class, Object.class);
        insertBefore(ctClass, "register", null, src);
    }

    public static void checkRegister(Object o, Object handler) {
        String controllerHandlerClassFilePath = null;
        HashMap<String, Object> params = new HashMap<String, Object>();
        if (handler instanceof String) {
            String handlerName = (String) handler;
            Object abstractHandlerMethodMapping = null;
            Object applicationContext = null;
            try {
                abstractHandlerMethodMapping = Reflection.getField(o, "this$0");
            } catch (Exception e) {
                LogTool.warn(ErrorType.HOOK_ERROR,"MappingRegistry hook check failed: can't get outter class for MappingRegistry", e);
                return;
            }
            if (abstractHandlerMethodMapping != null) {
                applicationContext = Reflection.invokeMethodWithSuperclass(abstractHandlerMethodMapping, "getApplicationContext", new Class[]{});
